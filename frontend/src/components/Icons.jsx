...
export const IconCloud = (p) => (
  <svg {...base} {...p}>
    <path d="M17.5 19a4.5 4.5 0 1 0-1.5-8.7 6 6 0 1 0-11.6 2.4A4 4 0 0 0 6 19h11.5z" />
  </svg>
);
